...
fn main() -> std::io::Result<()>{
    let mut f1 = File::create("wavefiles/square8.wav")?;
    let mut pcm1 = MonoPcm::new(44100, 8);
    let mut f2 = File::create("wavefiles/square16.wav")?;
    ...
    let mut f3 = File::create("wavefiles/square8_stereo.wav")?;
    let mut pcm3 = StereoPcm::new(44100, 8);
    let mut f4 = File::create("wavefiles/square16_stereo.wav")?;
